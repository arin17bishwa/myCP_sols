...
@yn_dec
def func():
    x1, y1, z1, x2, y2, z2 = int_arr()
    x3, y3, z3, x4, y4, z4 = int_arr()
    return (
        two_dim_intersection(x1, x2, x3, x4)
        and two_dim_intersection(y1, y2, y3, y4)
        and two_dim_intersection(z1, z2, z3, z4)
    )


def two_dim_intersection(l1, r1, l2, r2):
