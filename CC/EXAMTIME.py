...
def func():
    dragon_scores = list(int_arr())
    sloth_scores = list(int_arr())
    dragon_scores.insert(0, sum(dragon_scores))
    sloth_scores.insert(0, sum(sloth_scores))
    if dragon_scores > sloth_scores:
        return "DRAGON"
    elif dragon_scores < sloth_scores:
        return "SLOTH"
    return "TIE"
