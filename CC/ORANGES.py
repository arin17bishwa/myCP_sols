...
@lru_cache
def dfs(rem_oranges: int, rem_slices: int) -> bool:
    if rem_oranges == 0 and rem_slices == 0:
        return True
    if rem_oranges <= 0 or rem_slices <= 0:
        return False

    return (
            dfs(rem_oranges - 1, rem_slices - 10)
            or dfs(rem_oranges - 1, rem_slices - 11)
            or dfs(rem_oranges - 1, rem_slices - 12)
    )
